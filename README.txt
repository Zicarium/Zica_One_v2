...
Advertencia:
Hola hijo del diablo, quiero decirte que no me hago responsable de tus pecados y maldades con esta herramienta creada por 
Anonymous Unknown @Zicarium. Es por eso, que halla tu con lo que hagas. Dicho esto comnecemos explicar como funciona.


Recuerda que debes instalar antes los modulos y librerias necesarias con el comando:
...
Debes tener estos archivos con sus datos correspondidos y en la misma ruta:
numeros.txt : Numeros a llamar o sms.
remitente.txt : Numero Twilio
sid_token.txt : SID y Token Twilio
emails.txt : Lista de emails a enviar con Satanic Senderus Mailer
